...
G(\bm{x}_i;\bm{\mu}_i,\bm{\Sigma}_i) \sim \bm{P}_i  = |\bm{\Sigma}_i|^{-\frac{1}{(d+1)}} \left[ \begin{matrix}
...
\begin{equation}
G(\bm{p};\bm{\mu}_r,\bm{\Sigma}_r) \sim \bm{P}_r  = |\bm{\Sigma}_r|^{-\frac{1}{(d+1)}} \left[ \begin{matrix}
