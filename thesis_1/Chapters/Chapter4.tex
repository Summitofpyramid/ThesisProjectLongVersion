...
\label{zigzagdemo}
 ...
 To combine equations above, a ratio factor $\alpha$ is assigned to equation [] so that the target function can be denoted as 
  \begin{equation}
  \begin{aligned}
