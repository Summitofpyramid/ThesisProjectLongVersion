...
\renewcommand{\baselinestretch}{1.4} % control the line margin
%---------------------------------------------
...
\bibliography{citation.bib} % The filename of the bibliography
%\usepackage{cite}
%----------------------------------------------------------------------------------------
%----------------------------------------------------------------------------------------------------------------
%\usepackage{etoolbox}
...
\thesistitle{Person Re-identification Based on Kernel Local Fisher Discriminant Analysis and Mahalanobis Distance Learning} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
%\supervisor{Robert \textsc{Laganiere}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\university{\href{}{University of Ottawa}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
\department{\href{}{School of Electrical Engineering and Computer Science}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
\group{\href{}{VIVA lab}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
\faculty{\href{}{Faculty of Engineering}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
...
{\huge \bfseries \ttitle\par}\vspace{1.2cm} % Thesis title
...
\textit{A thesis submitted to the Faculty of Graduate and Postdoctoral Studies in fulfillment of the requirements for the degree of \degreename}\\ % University requirement text
\textit{in the}\\%\groupname\\
\textit{\deptname}\\ % Research group name and department name
\textit{Faculty of Engineering\\}
\textit{University of Ottawa}


%\begin{figure}[H]
%\includegraphics[width=0.5\linewidth]{/Users/JohnsonJohnson/Downloads/thesis_1/Figures/UOlogo.jpg}
%\vspace{-2em}
%\end{figure}
...
%{\large \today}\\[4cm] % Date
\begin{center}
\includegraphics[width=0.4\linewidth]{/Users/JohnsonJohnson/Downloads/thesis_1/Figures/UOlogo.jpg} % University/department logo - uncomment to place it
