...
\large \textit{A thesis submitted to the Faculty of Graduate and Postdoctoral Studies in fulfillment of the requirements\\ for the degree of \degreename}\\[0.3cm] % University requirement text
\textit{in the}\\[0.4cm]
...
\includegraphics[width=0.5\linewidth]{/Users/JohnsonJohnson/Downloads/thesis_1/Figures/UOlogo.jpg} % University/department logo - uncomment to place it
